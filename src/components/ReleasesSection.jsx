          ...
          <div className="flex gap-3">
            {platforms.map((platform) => (
              <a
                ...
                className={`w-10 h-10 bg-white rounded-full flex items-center justify-center hover:scale-110 hover:bg-red-600 transition-all group ${
                  platform === 'amazon' || platform === 'jiosaavn' ? 'p-2' : ''
                }`}
