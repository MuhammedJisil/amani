...
const ScrollExpandMedia = ({
  ...
  const textLeftX = useTransform(scrollYProgress, expandRange, ["0vw", `-${translateVal}vw`]);
  const textRightX = useTransform(scrollYProgress, expandRange, ["0vw", `${translateVal}vw`]);
